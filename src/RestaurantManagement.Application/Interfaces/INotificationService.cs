...
{
    Task<ApiResponse<PaginatedResultDto<NotificationDto>>> GetNotificationsAsync(int pageNumber = 1, int pageSize = 20, CancellationToken cancellationToken = default);
